  ...
  return (
    <>
      <Svg
        ...
        viewBox="0 0 200 200"
        {...props}
        style={{ position: "absolute", top: 182, right: 10, width: 130, zIndex: 0, opacity: 0.55 }}
      >
        <Path
          fill="#bee5c1"
      ...
      <Svg
        ...
        viewBox="0 0 200 200"
        {...props}
        style={{ position: "absolute", top: -30, left: -190, width: 380, zIndex: 0, opacity: 0.55 }}
      >
        <Path
          fill="#b6dbb9"
      ...
      <Svg
        ...
        viewBox="0 0 200 200"
        {...props}
        style={{ position: "absolute", bottom: -50, left: -34, width: 100, zIndex: 0, opacity: 0.55 }}
      >
        <Path
          fill="#b6dbb9"
