  ...
  return (
    <Modal
      ...
      style={{
        ...
        margin: 0,
        padding: 0,
        backgroundColor: theme === "dark" ? colors.darkCard : "#f8f8f8",
      }}
    >
      <SvgComponent />
      {theme === "dark" ? (
      ...
      <View style={[styles.modalHeader, { marginTop: -40 }]}>
        <Icon
          ...
          onPress={() => closeModal()}
        />
        <Text style={[styles.modalHeaderText, theme === "dark" && globalStyles.textLight]}>FAQ</Text>
        <Text></Text>
      </View>
        ...
        <View style={{ width: "100%", paddingBottom: 140 }}>
          <Collapse
            style={{
              marginBottom: 20,
              borderBottomWidth: 1,
              borderColor: theme === "dark" ? colors.greenLightDarkColor : "#f1f1f1",
              paddingBottom: 0,
            }}
          >
              ...
              >
                ...
                <View style={{ alignItems: "flex-end" }}>
                  <Icon
                    name="chevron-down"
                    size={33}
                    style={[styles.modalHeaderIcon, { color: theme === "dark" ? "#fff" : "#111", padding: 2 }]}
                  />
                </View>
              </View>
            </CollapseHeader>
            <CollapseBody>
              <Text
                style={[
                  globalStyles.label,
                  { fontSize: 14.5, marginRight: 10 },
                  theme === "dark" && { color: "#f1f1f1" },
                ]}
              >
